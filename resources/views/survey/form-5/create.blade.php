                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <form action="{{route('survey-FO5.store')}}" method="POST">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="textbelowInput" id="textbelowInput" placeholder="Enter Text Below Input">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>List Heading</label>
                                                    <input type="text" class="form-control" name="listHeading" id="listHeading" placeholder="Enter List Heading">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>List Item</label>
                                                    <input type="text" class="form-control" name="listItems[]" id="listItems" placeholder="Enter List Items">
                                                </div>
                                            </div>
                                            <div class="col-12">
