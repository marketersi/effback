                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form-11</h3>
                                </div>
                                <div class="p-3">
                                ...
                                <form action="{{route('survey-FO11.update')}}" method="POST">
                                    @csrf
                                    <div class="card-body">
                                    <input type="hidden" name="user_id" value="{{ $user->id }}" id="user_id">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>Option</label>
                                                    <input type="text" class="form-control" name="options[]" id="options{{$index + 1}}" placeholder="Enter Option" value="{{$option}}">
                                                </div>
                                            </div>
                                            @endforeach
                                            <div class="col-12">
    ...
    $(document).on('click', '.addfields', function(e) {
        ...
        var fieldHTML = `
            <div class="form-group">
                ...
                <input type="text" name="options[]" class="form-control" id="options" placeholder="Enter Option">
