                                ...
                                <form action="{{route('factowcard.store')}}" method="POST">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="feedbackContent">FactowCard Image URL</label>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="feedbackSubtitle">FactowCard Paragraph 1</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="feedbackSubtitle">FactowCard Paragraph 2</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="feedbackSubtitle">FactowCard Paragraph 3</label>
