        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Example 3 Form</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Example 3/Add</li>
                            </ol>
                        </div>
                    </div>
                </div>
                          ...
                          @if ($message = Session::get('success'))
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Add Example 3</h3>
                                </div>

                                <form action="{{route('example.example3Store')}}" method="post">
                                    @csrf
                                          ...
                                          <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="quote_name" id="quote_name" value="{{  optional($details->where('type', 'quote_name')->first())->message ?? '' }}" placeholder="Enter quote name" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
