        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Example 16 Form</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Example 16/Add</li>
                            </ol>
                        </div>
                    </div>
                </div>
                          ...
                          @if ($message = Session::get('success'))
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Add Example 16</h3>
                                </div>

                                <form action="{{route('example.example16Store')}}" method="post">
                                    @csrf
