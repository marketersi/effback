        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Example 19 Form</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Example 19/Add</li>
                            </ol>
                        </div>
                    </div>
                </div>
                          ...
                          @if ($message = Session::get('success'))
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Add Example 19</h3>
                                </div>

                                <form action="{{route('example.example19Store')}}" method="post">
                                    @csrf
                                          ...
                                          <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" cols="10" rows="5" class="form-control" name="para_2" id="para_2" placeholder="Enter paragraph 2" required> {{  $details->where('type', 'para_2')->first()->message ?? '' }} </textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
