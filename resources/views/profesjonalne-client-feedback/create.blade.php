                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <form action="{{route('profesjonalne-client-feedback.store')}}" method="POST">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="url" class="form-control" name="image_url" id="image_url" @if(isset($clientFeedback)) value='{{ $clientFeedback->image_url }}' @endif placeholder="Enter Client Image URL">
                                                </div>
                                            </div>
