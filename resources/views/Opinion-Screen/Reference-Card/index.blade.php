          ...
          <div class="card">
            <div class="card-header">
              <div style="float: left;">
                <h3 class="card-title">Reference Card</h3>
              </div>
              <div style="float: right;">
                <a href="{{ route('reference-card.create') }}" class="btn btn-primary">  
                  Add Reference Card 
                </a>
              </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  @foreach($ReferenceCard as $value)
                  <tr>
                  <td>{{ $loop->iteration }}</td>
                    ...
                    <td>{{ $value->review}}</td>
                    <td><form method="get" action="{{ route('reference-card.edit') }}">
                            @csrf
