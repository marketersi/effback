          ...
          <div class="card">
            <div class="card-header">
              <div style="float: left;">
                <h3 class="card-title">Brilliant Job</h3>
              </div>
              @if(count($brilliantJob)< 3)
              <div style="float: right;">
                <a href="{{ route('brilliant-job.create') }}" class="btn btn-primary">  
                  Add Brilliant Job   
                </a>
              </div>
              @endif
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <td>{{ $loop->iteration }}</td>
                    ...
                    <td><form method="get" action="{{ route('brilliant-job.edit') }}">
                            @csrf
