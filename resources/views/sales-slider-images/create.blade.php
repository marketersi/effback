                                ...
                                <form action="{{route('slider-section-images.store')}}" method="POST">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="feedbackSubtitle">Carousel Images</label>
                                                    <textarea type="url" cols="5" rows="5" class="form-control" name="carousel_images" id="carousel_images" placeholder="Enter Images"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
