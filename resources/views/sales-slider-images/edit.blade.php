                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="url" cols="5" rows="5" class="form-control" name="carousel_images" id="carousel_images" placeholder="Enter Feedback subtitle">@if(isset($sliderSectionImages)){{ $sliderSectionImages->images }}@endif</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
