          ...
          <div class="card">
            <div class="card-header">
                <div style="float: left;">
                    <h3 class="card-title">Receive Points</h3>
                </div>
                <div class="col-sm-2 pr-0 float-right">
                    <!-- projectCount -->
                    <a href="{{ route('receive.points.create') }}" class="btn btn-primary float-right">Add Receive Points</a>
                </div>
                ...
                @php
                  ...
                  <tr>
                    <td>{{ $i++ }}</td>
                      <td>{{$data->point}}</td>
                      <td>
                        <form method="get" action="{{ route('receive.points.edit') }}">
                            @csrf
