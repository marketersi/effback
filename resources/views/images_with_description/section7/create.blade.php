                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="post" action="{{ route('homesection7.store')}}" class="needs-validation" novalidate>
                                @csrf
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <textarea type="text" id="paragraph_1" name="paragraph_1" required class="form-control" value="">{{  $details->where('type', 'paragraph_1')->first()->message ?? '' }}</textarea>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
