                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <form action="{{route('opinion-rating.store')}}" method="POST">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>Opinion</label>
                                                    <input type="text" class="form-control" name="opinion" id="opinion" placeholder="Enter Opinion">
                                                </div>
                                            </div>
                                            </div>
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" cols="10" rows="5" class="form-control"  name="para" id="para" placeholder="Enter Paragraph"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
