                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input type="hidden" name="update_id"
                                                        @if (isset($feedback_details)) value="{{ $feedback_details->id }}" @endif>
                                                    <label for="feedbackTitle">Feedback Title</label>
                                                    <input type="text" class="form-control" name="feedbackTitle"
                                                        id="feedbackTitle"
                                                        @if (isset($feedback_details)) value='{{ $feedback_details->feedback_title }}' @endif
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" cols="10" rows="5" class="form-control" name="feedbackContent" id="feedbackContent"
                                                        placeholder="Enter feedback content">
@if (isset($feedback_details))
...
@endif
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="feedbackSubtitle"
                                                        @if (isset($feedback_details)) value='{{ $feedback_details->feedback_subtitle }}' @endif
                                                        id="feedbackSubtitle" placeholder="Enter Feedback subtitle">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
