                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-sm-2 pr-0">
                              <a href="{{ route('testimonial.create') }}" class="btn btn-primary float-right">Update Testimonial Data</a>
                          </div>
                            @endif
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($testimonial as $data)
                                  <tr>
                                    ...
                                    <td>{{ $data->status }}</td>
                                    <td>                                 
                                      <form method="POST" action="{{ route('status.testimonial', ['id' => $data->id]) }}">
                                          @csrf
                                          @method('PUT')
