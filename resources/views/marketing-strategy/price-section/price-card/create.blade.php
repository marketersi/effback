                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="subtitle_1" id="subtitle_1" @if(isset($priceCard)) value='{{ $priceCard->subtitle }}' @endif placeholder="Enter Subtitle-1">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="button_text" id="button_text" @if(isset($priceCard)) value='{{ $priceCard->button_text }}' @endif placeholder="Enter Button Text">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
